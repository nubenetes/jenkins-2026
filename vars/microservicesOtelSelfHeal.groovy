 ...
 * is visible as its own stage in the build UI. The same self-heal — including the
 * app-container check below — runs in all four engines: Tekton's gitops-deploy task
 * (docs/404), the GitHub Actions rendered workflow (docs/405) and the Argo Workflows
 * template (docs/406).
 *
