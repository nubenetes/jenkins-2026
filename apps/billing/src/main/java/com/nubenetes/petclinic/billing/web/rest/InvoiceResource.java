package com.nubenetes.petclinic.billing.web.rest;

import com.nubenetes.petclinic.billing.repository.InvoiceRepository;
import com.nubenetes.petclinic.billing.service.InvoiceService;
import com.nubenetes.petclinic.billing.service.dto.InvoiceDTO;
import com.nubenetes.petclinic.billing.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.nubenetes.petclinic.billing.domain.Invoice}.
 */
@RestController
...
public class InvoiceResource {
    ...
    private static final String ENTITY_NAME = "billingInvoice";
    ...
    public ResponseEntity<List<InvoiceDTO>> getAllInvoices(
        ...
        if ("payment-is-null".equals(filter)) {
            ...
            return new ResponseEntity<>(invoiceService.findAllWherePaymentIsNull(), HttpStatus.OK);
        }
