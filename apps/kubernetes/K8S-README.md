...
```
$ docker image tag gateway ghcr.io/nubenetes/gateway
$ docker push ghcr.io/nubenetes/gateway
$ docker image tag customers ghcr.io/nubenetes/customers
$ docker push ghcr.io/nubenetes/customers
$ docker image tag billing ghcr.io/nubenetes/billing
$ docker push ghcr.io/nubenetes/billing
```
...
```
$ kubectl get svc gateway -n petclinic
```
...
```
kubectl scale deployment <app-name> --replicas <replica-count> -n petclinic
```
...
```
kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n petclinic
```
