...
describe('Owner e2e test', () => {
  ...
  describe('new Owner page', () => {
    ...
    it('should create an instance of Owner', () => {
      cy.get(`[data-cy="address"]`).type('outset');
      cy.get(`[data-cy="address"]`).should('have.value', 'outset');

      cy.get(`[data-cy="city"]`).type('South Ilene');
      cy.get(`[data-cy="city"]`).should('have.value', 'South Ilene');

      cy.get(`[data-cy="telephone"]`).type('555-678-9043 x619');
      cy.get(`[data-cy="telephone"]`).should('have.value', '555-678-9043 x619');
