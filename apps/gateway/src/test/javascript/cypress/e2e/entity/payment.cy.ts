...
describe('Payment e2e test', () => {
  ...
  const paymentSample = { amount: 23653.15, paymentDate: '2026-06-14T23:09:24.633Z', method: 'CASH' };
  ...
  describe('new Payment page', () => {
    ...
    it('should create an instance of Payment', () => {
      cy.get(`[data-cy="amount"]`).type('15382.32');
      cy.get(`[data-cy="amount"]`).should('have.value', '15382.32');

      cy.get(`[data-cy="paymentDate"]`).type('2026-06-15T07:39');
      cy.get(`[data-cy="paymentDate"]`).blur();
      cy.get(`[data-cy="paymentDate"]`).should('have.value', '2026-06-15T07:39');
