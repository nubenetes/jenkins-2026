...
describe('Customer e2e test', () => {
  ...
  const customerSample = { firstName: 'Marques', lastName: 'Rolfson', email: 'efB-a4@wv$&.4' };
  ...
  describe('new Customer page', () => {
    ...
    it('should create an instance of Customer', () => {
      cy.get(`[data-cy="firstName"]`).type('Martine');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Martine');

      cy.get(`[data-cy="lastName"]`).type('Blick');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Blick');

      cy.get(`[data-cy="email"]`).type('=p,@I|[x._');
      cy.get(`[data-cy="email"]`).should('have.value', '=p,@I|[x._');
