package com.nubenetes.petclinic.gateway.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.nubenetes.petclinic.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.nubenetes.petclinic.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
