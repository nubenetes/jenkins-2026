...
import com.nubenetes.petclinic.customers.service.CustomerService;
...
/**
 * REST controller for managing {@link com.nubenetes.petclinic.customers.domain.Customer}.
 */
@RestController
...
public class CustomerResource {
    ...
    public ResponseEntity<List<CustomerDTO>> getAllCustomers(
        ...
        if ("owner-is-null".equals(filter)) {
            LOG.debug("REST request to get all Customers where owner is null");
            return new ResponseEntity<>(customerService.findAllWhereOwnerIsNull(), HttpStatus.OK);
        }
