...
import static com.nubenetes.petclinic.customers.domain.CustomerAsserts.*;
import static com.nubenetes.petclinic.customers.web.rest.TestUtil.createUpdateProxyForBean;
...
import com.nubenetes.petclinic.customers.IntegrationTest;
import com.nubenetes.petclinic.customers.domain.Customer;
import com.nubenetes.petclinic.customers.repository.CustomerRepository;
import com.nubenetes.petclinic.customers.service.dto.CustomerDTO;
import com.nubenetes.petclinic.customers.service.mapper.CustomerMapper;
...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "4lWR?v@fL?.8";
    private static final String UPDATED_EMAIL = "+cUI*1@.6)kkP.P'}s%f";
